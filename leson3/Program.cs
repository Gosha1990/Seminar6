...
// все введеные символы числами


// var  stringNumber = "1234hghj";
// int number;
...
// Console.Write("Введите координату А по оси Х: ");
// int x1 = Convert.ToInt32(Console.ReadLine);
// Console.Write("Введите координату А по оси Y: ");
// int y1 = Convert.ToInt32(Console.ReadLine);
// Console.Write("Введите координату B по оси Х: ");
// int x2 = Convert.ToInt32(Console.ReadLine);
// Console.Write("Введите координату B по оси Х: ");
// int y2 = Convert.ToInt32(Console.ReadLine);
// var result = Math.Sqrt(Math.Pow(x2 - x1) + Math.Pow(y2 - y1));
